...
from torchstat import compute_bops
...
class ModelHook(object):
    ...
    def _register_buffer(module):
        ...
        module.register_buffer('Bops', torch.zeros(1).long())
    ...
    def _sub_module_call_hook(self):
        def wrap_call(module, *input, **kwargs):
            ...
            module.Bops = torch.from_numpy(
                np.array([bops], dtype=np.int64))
